...
\begin{figure}[htb]
	...
	\caption{Overview of functionality supported by different APIs. Information regarding support was taken directly from each API's respective documentation.Green indicates the functionality is fully 
