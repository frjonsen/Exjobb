...
where each module has its own well-defined interface, and there should be no need to modify the interface when changing the modules actual implementation.
...
Despite being abandoned, we hope the research community can still learn from the problems the similar libraries encountered and solved. For this, we looked into each projects issue
