...
developer. As Henning points out in his article\autocite{Henning:2007:ADM:1255421.1255422}, about design of APIs, it’s very easy to create a bad one, 
...
Several similar works serve the same purpose \footnote{http://www.agorava.org/}\footnote{https://github.com/gorbin/ASNE}\footnote{https://github.com/socialsensor/socialmedia-abstractions}, but none are still maintained. There are also commercial 
services\footnote{https://cloudrail.com} which provide this functionality for some popular APIs, but charge money to sign up
